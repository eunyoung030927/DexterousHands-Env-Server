    ...
    def run(self):
        ...
        for episode in range(episodes):
            if self.use_linear_lr_decay:
                for agent_trainer in self.trainer: # for each agent 
                    agent_trainer.policy.lr_decay(episode, episodes) # update learning rate
    ...
    def collect_data(self, total_episodes, save_name="mappo_dataset", multi_to_single=False):
        ...
        while episode_count < total_episodes:
            ...
            for agent_id in range(self.num_agents):
                ...
                temp_rnn_states_list.append(temp_rnn_state)
